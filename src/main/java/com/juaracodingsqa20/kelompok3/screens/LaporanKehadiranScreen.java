...
public class LaporanKehadiranScreen {
    ...
    private final By FIRST_EXPORT_BUTTON = By.xpath(
            "//button[contains(@class, 'MuiButton-containedPrimary') and contains(text(), 'Export') and contains(@class, 'css-112fgj')]");
    private final By SECOND_EXPORT_BUTTON = By.xpath(
            "//button[contains(@class, 'MuiButton-containedPrimary') and contains(text(), 'Export') and contains(@class, 'css-4075ia')]");
    private final By CANCEL_EXPORT_BUTTON = By
            .xpath("//button[contains(@class, 'MuiButton-textSecondary') and contains(text(), 'Batal')]");
    ...
    public void pressFirstExportButton() {
        WebElement firstExportButtonElement = DriverWaitHelper.DRIVER_WAIT
                .until(ExpectedConditions.elementToBeClickable(FIRST_EXPORT_BUTTON));
        firstExportButtonElement.click();
    }

    public void pressSecondExportButton() {
        WebElement secondExportButtonElement = DriverWaitHelper.DRIVER_WAIT
                .until(ExpectedConditions.elementToBeClickable(SECOND_EXPORT_BUTTON));
        secondExportButtonElement.click();
    }

    public void pressCancelExportButton() {
        WebElement cancelExportButtonElement = DriverWaitHelper.DRIVER_WAIT
                .until(ExpectedConditions.elementToBeClickable(CANCEL_EXPORT_BUTTON));
        cancelExportButtonElement.click();
    }
    ...
    public boolean isExportDialogClosed() {
        try {
            return DriverWaitHelper.DRIVER_WAIT.until(ExpectedConditions
                    .invisibilityOfElementLocated(By.xpath("//h2[text()='Export Activities']")));
        } catch (Exception e) {
            return true;
        }
    }
