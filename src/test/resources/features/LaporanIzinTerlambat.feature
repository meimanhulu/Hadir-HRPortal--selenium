Feature: Laporan Izin Terlambat
  ...
  Scenario: Menghilangkan Parameter-parameter Filter Laporan Izin Terlambat yang Dibuat
    ...
    And Departemen "IT Programmer" di Kolom Filter Departemen Laporan Izin Terlambat
    And Saya Memfilter Departemen Laporan Izin Terlambat
    And Tanggal Mulai "19/11/2024" di Kolom Filter Tanggal Laporan Izin Terlambat
    And Tanggal Selesai "23/11/2024" di Kolom Filter Tanggal Laporan Izin Terlambat
